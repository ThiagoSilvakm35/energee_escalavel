"""
Django settings for energee_project project.
...
ROOT_URLCONF = 'energee_project.urls'
...
WSGI_APPLICATION = 'energee_project.wsgi.application'
ASGI_APPLICATION = 'energee_project.asgi.application'

# Database
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgresql://energee_user:energee_password_123@localhost:5432/energee_db')
    )
}
...
TENANT_MODEL = 'distribuidoras.Distribuidora'
